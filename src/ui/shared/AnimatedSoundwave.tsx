...
/* SVG from https://codepen.io/maxbrunel/pen/vYORBRw */
interface Props {
    size: string;
    color: string;
...
export const AnimatedSoundwave: React.FC<Props> = ({ size, color, style }) => {
    return (
        <svg
            width="10px"
            height="8px"
            ...
            style={{ ...style, width: size, height: size, color: color }}
        >
            <g
                id="Audio"
